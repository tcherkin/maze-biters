...
function limb(side,front){
  ...
  const elbow=[side*(front?.311:.301),front?.285:.254,z+.012];
  const wrist=[side*(front?.351:.344),front?.216:.218,z+.105];
  ...
  return {...parts,z,pivot:shoulder,elbow,wrist,side,front,boneIndex,restZ:restZ[boneIndex],tip:[0,-.030,.139]};
}
...
export function createCrystalDragon(){
  ...
  for(const [i,part]of limbParts.entries()){
    ...
    paddlePaws.push({pivot:group,elbow,wrist,tip,side:part.side,front:part.front,
  ...
  model.userData.paddleRig={paws:paddlePaws,articulated:true};
  ...
  model.userData.modelVersion='crystal-dragon-v3';model.userData.finishVersion='sculpted-deep-emerald-gold-v2';
